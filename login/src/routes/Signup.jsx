...
function Signup() {
  ...
  return (
    ...
    <DefaultLayout>
      ...
      <h1 className="flex justify-center font-bold bg-white rounded-lg">Signup</h1>
      ...
      <br/>
      <button className="flex justify-center font-bold text-white border-2 border-white rounded-lg bg-blue-700">Create User</button>
    </form>
    </DefaultLayout>
    </>
  )
